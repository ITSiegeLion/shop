...
import com.lsf.enums.YesOrNo;
import com.lsf.pojo.Carousel;
import com.lsf.pojo.Category;
import com.lsf.pojo.vo.CategoryVO;
import com.lsf.pojo.vo.NewItemsVO;
import com.lsf.service.CarouselService;
...
public class IndexController {
    ...
    public JsonResult subCat(
        ...
        if (rootCatId == null) {
            return JsonResult.getErrorResult("分类不存在");
        }
